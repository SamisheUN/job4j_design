...
class NonCollisionMapTest {
    ...
    @Test
    void additionalPutTest() {
        assertThat(map.put(1, "1")).isFalse();
        assertThat(map.put(1, "2")).isFalse();
        assertThat(map.remove(1)).isTrue();
        assertThat(map.put(1, "1")).isTrue();
        assertThat(map.put(9000, "0")).isTrue();
    }

    @Test
    void additionalGetTest() {
        assertThat(map.get(1)).isEqualTo("1");
        assertThat(map.put(9000, "19999")).isTrue();
        assertThat(map.get(9000)).isEqualTo("19999");
    }

    @Test
    void additionalRemoveTest() {
        assertThat(map.remove(9000)).isFalse();
        assertThat(map).hasSize(4);
        assertThat(map.put(9000, "19999")).isTrue();
        assertThat(map.remove(9000)).isTrue();
        assertThat(map.remove(9000)).isFalse();
    }
}
